...
export class Input extends BaseNode {
    ...
    protected onBuild(): void {
        ...
        this.addWidget("text", "Question", "", (v: string) => {
            if(v.trim() === "" && !this.inputs.at(1)) this.addInput("Question", FlowIOTypes.Any);
    ...
    nodeToCode(generator: BaseGenerator): string {
        const printValue = !this.inputs[1]?.link ? JSON.stringify(this.properties.question) : generator.valueToCode(this, 1);
